...
export default async function CampaignsPage({
  ...
  const href = (nextTab: string) =>
    `/admin/campanhas?id=${encodeURIComponent(selected?.id || "")}&aba=${nextTab}`;
  ...
  return (
    <>
      <PageHeader
        ...
        action={
          <Link href="/admin/campanhas?nova=1" className={primaryButton}>
            <Plus size={15} />
            Nova campanha
          </Link>
        }
                      ...
                      <tr key={campaign.id} className="hover:bg-[#f7faf8]">
                        <td className="px-5 py-5">
                          <Link
                            ...
                            href={`/admin/campanhas?id=${campaign.id}`}
                          >
                            {campaign.name}
                          </Link>
                        ...
                        <td className="px-5 py-5">
                          {pending ? (
                            <Link
                              ...
                              href={`/admin/campanhas?id=${campaign.id}&aba=mensagens`}
                            >
                        ...
                        <td className="px-5 py-5">
                          ...
                          <Link
                            ...
                            href={`/admin/campanhas?id=${campaign.id}&aba=configuracoes`}
                          >
                            <Settings2 size={13} />
                            Editar
                          </Link>
            ...
            <div className="space-y-5">
              <section className="overflow-hidden rounded-2xl border border-[#e1e1db] bg-white">
                <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#edf0ec] p-5">
                  ...
                  <form action="/admin/campanhas" method="get">
                    <input type="hidden" name="id" value={selected.id} />
