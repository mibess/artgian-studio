...
export function LeadLink({ id, children }: { id: string; children: React.ReactNode }) {
  return <Link className="inline-flex items-center gap-1 text-xs font-bold text-[#d96245] hover:text-[#b74a31]" href={`/admin/leads/${id}`}>{children}<ChevronRight size={13}/></Link>;
}
